defmodule WalletTest do
  ...
  test "depositing to one of two wallets" do
    ...
    # Alice has 242
    assert Aggregate.aggregate_state(Wallet.Application, Wallet.Wallet, wallet_id_alice) == %Wallet.Wallet{
      id: wallet_id_alice,
      balance: 242
    }
    ...
    # Bob still has 0
    assert Aggregate.aggregate_state(Wallet.Application, Wallet.Wallet, wallet_id_bob) == %Wallet.Wallet{
      id: wallet_id_bob,
      balance: 0
    }
  end
